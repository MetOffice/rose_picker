...
module bad__groupABC__meta_mod
  ...
  type, public :: bad__groupABC__meta_type

    !> Declare the name of your fields here
    type(field_meta_data_type), public :: &
      test_1, &
      test_2
    character(str_def) :: name = "bad__groupABC"
    end type bad__groupABC__meta_type

  interface bad__groupABC__meta_type
...
end module bad__groupABC__meta_mod